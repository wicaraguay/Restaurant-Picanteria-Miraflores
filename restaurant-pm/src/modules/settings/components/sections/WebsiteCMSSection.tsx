...
const WebsiteCMSSection: React.FC<WebsiteCMSSectionProps> = ({
    ...
    // Esto asegura que los datos guardados en MongoDB se muestren correctamente
    ...
    // Siempre guardar el objeto website completo para evitar pérdida de datos
                    ...
                    <form onSubmit={handleSaveHero} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1">
                                    Intervalo (ms): {hero.interval || 5000}
                                </label>
                                <input
                                    type="range"
                                    min="2000"
                                        ...
                                        <div className="flex gap-2">
                                            {index > 0 && (
                                                <button
                                                    ...
                                                    className="p-2 rounded-lg bg-gray-100 dark:bg-dark-800 hover:bg-gray-200 dark:hover:bg-dark-700 transition-all"
                                                    title="Mover arriba"
                                                >
                                            ...
                                            <button
                                                ...
                                                className="p-2 rounded-lg bg-red-100 dark:bg-red-900/30 hover:bg-red-200 dark:hover:bg-red-900/50 transition-all"
                                                    ...
                                                    <div className="relative aspect-video rounded-xl overflow-hidden border border-gray-200 dark:border-dark-700">
                                                        ...
                                                        <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center">
                                                            <button
                                                                ...
                                                                className="bg-white text-gray-900 px-4 py-2 rounded-xl font-black text-[10px] uppercase tracking-widest shadow-lg"
                                                            >
                                                                Cambiar
                                                            </button>
                                                        </div>
                        ...
                        <div className="flex justify-end pt-4 border-t border-gray-200 dark:border-dark-700">
                            <button
                                type="submit"
                                disabled={isSaving}
                                className="bg-purple-600 text-white px-8 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-purple-700 transition-all shadow-xl shadow-purple-500/25 active:scale-95 disabled:bg-purple-300"
                            >
                    ...
                    <form onSubmit={handleSaveFooter} className="space-y-6">
                            ...
                            {footer.schedules.map((schedule, index) => (
                                <div key={index} className="flex gap-3 items-end">
                                    ...
                                    <button
                                        ...
                                        className="p-3 rounded-xl bg-red-100 dark:bg-red-900/30 hover:bg-red-200 dark:hover:bg-red-900/50 transition-all flex-shrink-0"
                        ...
                        <div className="flex justify-end pt-4 border-t border-gray-200 dark:border-dark-700">
                            <button
                                type="submit"
                                disabled={isSaving}
                                className="bg-blue-600 text-white px-8 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-blue-700 transition-all shadow-xl shadow-blue-500/25 active:scale-95 disabled:bg-blue-300"
                            >
                    ...
                    <form onSubmit={handleSaveTheme} className="space-y-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-4 group">
                                    ...
                                    <div className="flex-1 space-y-1">
                                        <p className="text-[8px] font-black uppercase tracking-widest text-gray-600 dark:text-gray-400">Fondo</p>
                                        <input
                                            type="text"
                                            value={theme.colors.background}
                                            onChange={(e) => setTheme({ ...theme, colors: { ...theme.colors, background: e.target.value } })}
                                ...
                                <div className="flex items-center gap-4 group">
                                    ...
                                    <div className="flex-1 space-y-1">
                                        <p className="text-[8px] font-black uppercase tracking-widest text-gray-600 dark:text-gray-400">Texto</p>
                                        <input
                                            type="text"
                                            value={theme.colors.text}
                                            onChange={(e) => setTheme({ ...theme, colors: { ...theme.colors, text: e.target.value } })}
                        ...
                        <div className="flex justify-end pt-4 border-t border-gray-200 dark:border-dark-700">
                            <button
                                type="submit"
                                disabled={isSaving}
                                className="bg-green-600 text-white px-8 py-3 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-green-700 transition-all shadow-xl shadow-green-500/25 active:scale-95 disabled:bg-green-300"
                            >
