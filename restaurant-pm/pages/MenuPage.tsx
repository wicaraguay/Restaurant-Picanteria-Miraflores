            ...
            <header className="relative h-[70vh] overflow-hidden bg-gradient-to-br from-amber-50 via-orange-50 to-red-50">
                ...
                <div className="relative h-full flex items-center justify-center text-center px-4">
                    ...
                    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in relative">
                        ...
                        {/* Title */}
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight drop-shadow-2xl animate-pop-in whitespace-nowrap" style={{ fontFamily: '"Architects Daughter", cursive' }}>
                            {config.name}
                        </h1>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <img src="/image1.png" alt="Sabor Tradicional" className="mt-4 w-40 h-auto opacity-90 hover:opacity-100 transition-opacity mx-auto md:mx-0" />
                        </div>
